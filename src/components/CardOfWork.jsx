   ...
   return (
      <>
         <div className="max-w-sm rounded overflow-hidden shadow-xl shadow-dimBlue mb-14">
            <a href={work.link}>
               <img className="w-full object-contain scale-100 hover:scale-y-105 hover:scale-x-110 transition-all duration-500" src={work.img} alt="Sunset in the mountains  " />
            </a>
